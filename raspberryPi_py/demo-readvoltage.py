...
while (True):
    ...
    print ("Channel 1: %02f" % adc.read_voltage(5))
    print ("Channel 2: %02f" % adc.read_voltage(6))
    print ("Channel 3: %02f" % adc.read_voltage(7))
    print ("Channel 4: %02f" % adc.read_voltage(8))
